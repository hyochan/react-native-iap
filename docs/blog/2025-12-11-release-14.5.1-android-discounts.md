...
description: React Native IAP 14.5.1 adds full support for Google Play one-time product discounts and new purchase status fields from Billing Library 7.0+ and 8.1.0+.
date: 2025-12-11
---
...
- [Google Play Billing Library 7.0 Release Notes](https://developer.android.com/google/play/billing/release-notes#7-0)
