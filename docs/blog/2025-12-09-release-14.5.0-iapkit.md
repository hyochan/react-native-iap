...
React Native IAP 14.5.0 brings **built-in purchase verification** (aka receipt validation) powered by <IapKitLink>IAPKit</IapKitLink>. Now you can verify purchases with enterprise-grade backend validation using a single API call—no server setup required.
...
- <IapKitLink>IAPKit Documentation</IapKitLink>
