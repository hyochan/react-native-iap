---
slug: 14.7.5
title: 14.7.5 - ExternalPurchaseCustomLink API (iOS 18.1+)
authors: [hyochan]
tags: [release, ios, storekit, external-purchase, ios-18]
date: 2026-01-26
---

# 14.7.5 Release Notes

react-native-iap 14.7.5 adds support for Apple's **ExternalPurchaseCustomLink** API (iOS 18.1+) for apps using custom external purchase links.
...
```bash
npm install react-native-iap@14.7.5
# or
yarn add react-native-iap@14.7.5
```
