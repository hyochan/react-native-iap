...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    explicit ExternalPurchaseNoticeResultIOS(std::optional<std::variant<nitro::NullType, std::string>> error, ExternalPurchaseNoticeAction result): error(error), result(result) {}
